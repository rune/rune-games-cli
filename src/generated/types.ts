...
export type GamesQuery = { __typename: 'Query', games: { __typename: 'GamesConnection', nodes: Array<{ __typename: 'Game', id: number, title: string, devTeamId: number, devTeam: { __typename: 'DevTeam', id: number, handle: string | null } | null, gameVersions: { __typename: 'GameVersionsConnection', nodes: Array<{ __typename: 'GameVersion', gameId: number, gameVersionId: number, status: GameVersionStatus, supportsChallenge: boolean }> } }> } | null };
...
export type DevTeamKeySpecifier = ('admin' | 'createdAt' | 'email' | 'games' | 'handle' | 'id' | 'updatedAt' | DevTeamKeySpecifier)[];
...
export type MutationKeySpecifier = ('checkVerification' | 'createGame' | 'createGameVersion' | 'startVerification' | 'updateDevTeamByEmail' | 'updateDevTeamByHandle' | 'updateDevTeamById' | 'updateGame' | 'validateGame' | MutationKeySpecifier)[];
